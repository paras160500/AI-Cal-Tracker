...
/**
 * Renders the sign-up screen that lets users create an account and complete email verification.
 *
 * Supports collecting first name, last name, email, and password, initiating Clerk email-code verification,
 * accepting a verification code, activating the session on success, and navigating to the app root.
 *
 * @returns The JSX element for the sign-up and verification UI.
 */
