...
/**
 * Renders the main Home/Dashboard screen showing user greeting, daily progress, macros breakdown, and a floating "Log New Meal" action with animated UI.
 *
 * Synchronizes user data on mount and provides a logout action that triggers light haptic feedback and signs the user out.
 *
